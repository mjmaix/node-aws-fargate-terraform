...
variable "container_secrets" {
  ...
  description = "he secrets to pass to the container. This is a list of maps"
}
...
# Either github_oauth_token or codestar_connection_arn must be provided
variable "github_oauth_token" {
  type        = string
  description = "GitHub OAuth Token with permissions to access private repositories. Either github_oauth_token or codestar_connection_arn must be provided"
  default     = ""
}

variable "codestar_connection_arn" {
  type        = string
  description = "Codestar connection to repository. Either github_oauth_token or codestar_connection_arn must be provided"
  default     = ""
}
